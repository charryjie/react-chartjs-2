(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ReactChartjs2 = {}, global.React, global.Chart));
  ...
  */
  ...
  var ChartComponent = /*#__PURE__*/function (_React$Component) {
    ...
    _createClass(ChartComponent, [{
      ...
      value: function memoizeDataProps() {
        ...
        this.shadowDataProp = _objectSpread2(_objectSpread2({}, data), {}, {
          datasets: data.datasets && data.datasets.map(function (set) {
            return _objectSpread2({}, set);
          })
        });
      ...
      value: function updateChart() {
        ...
        if (options) {
          this.chartInstance.options = Chart__default['default'].helpers.configMerge(this.chartInstance.options, options);
        ...
        var currentDatasetsIndexed = keyBy_1(currentDatasets, this.props.datasetKeyProvider); // We can safely replace the dataset array, as long as we retain the _meta property
        // on each dataset.
        ...
        this.chartInstance.config.data.datasets = nextDatasets.map(function (next) {
          ...
          if (current && current.type === next.type && next.data) {
            ...
            return _objectSpread2(_objectSpread2({}, current), otherProps);
          } else {
            return next;
          }
        });
        ...
        this.chartInstance.config.data = _objectSpread2(_objectSpread2({}, this.chartInstance.config.data), rest);
      ...
      value: function renderChart() {
        ...
        this.chartInstance = new Chart__default['default'](node, {
          type: type,
          data: data,
          options: options,
          plugins: plugins
  ...
  _defineProperty(ChartComponent, "propTypes", {
    ...
    type: function type(props, propName, componentName) {
      if (!Chart__default['default'].controllers[props[propName]]) {
  ...
  var Doughnut = /*#__PURE__*/function (_React$Component2) {
    ...
    _createClass(Doughnut, [{
      ...
      value: function render() {
        ...
        return /*#__PURE__*/React__default['default'].createElement(ChartComponent, _extends({}, this.props, {
  ...
  var defaults = Chart__default['default'].defaults;

  Object.defineProperty(exports, 'Chart', {
    enumerable: true,
    get: function () {
      return Chart__default['default'];
    }
  });
  exports.Bar = Bar;
